            ...
            <View style={{width:'100%',padding:20}}>
                <TouchableOpacity style={{width:'100%',paddingBottom:20}} onPress={() => router.push('/newsDetail')}>
                     <View style={{width:'100%',padding:20,borderRadius:10, backgroundColor:'#FFF',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                         ...
                         <Image source={require("../../assets/images/PC/1.jpg")} style={{width:120,height:120, borderRadius:5}} resizeMode='cover'/>
                     </View>
                </TouchableOpacity>
                <TouchableOpacity style={{width:'100%',paddingBottom:20}}>
                     <View style={{width:'100%',padding:20,borderRadius:10, backgroundColor:'#FFF',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                         ...
                         <Image source={require("../../assets/images/PC/2.jpg")} style={{width:120,height:120, borderRadius:5}} resizeMode='cover'/>
                     </View>
                </TouchableOpacity>
                <TouchableOpacity style={{width:'100%',paddingBottom:20}}>
                     <View style={{width:'100%',padding:20,borderRadius:10, backgroundColor:'#FFF',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                         ...
                         <Image source={require("../../assets/images/PC/3.jpg")} style={{width:120,height:120, borderRadius:5}} resizeMode='cover'/>
                     </View>
                </TouchableOpacity>
                <TouchableOpacity style={{width:'100%',paddingBottom:20}}>
                     <View style={{width:'100%',padding:20,borderRadius:10, backgroundColor:'#FFF',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                         ...
                         <Image source={require("../../assets/images/PC/4.jpg")} style={{width:120,height:120, borderRadius:5}} resizeMode='cover'/>
                     </View>
                </TouchableOpacity>
                <TouchableOpacity style={{width:'100%',paddingBottom:20}}>
                     <View style={{width:'100%',padding:20,borderRadius:10, backgroundColor:'#FFF',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                         ...
                         <Image source={require("../../assets/images/PC/5.jpg")} style={{width:120,height:120, borderRadius:5}} resizeMode='cover'/>
                     </View>
                </TouchableOpacity>
            </View>
        </ScrollView>
